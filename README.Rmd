...
`craneur` provides a user-friendly API for creating this skeleton : `PACKAGES` file, tar.gz, and a minimal `index.html`. Note that for now you need to specify if your package needs compilation.
